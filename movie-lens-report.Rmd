...
Similar to other effects, to compute $b_u$ we group data by user, and substraact all other effects:
```{r}
...
```
Finally, we compute the RMSE on the test set:
```{r}
